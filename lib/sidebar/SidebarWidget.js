                ...
                React.createElement("div", { className: `ds-code-review-message ds-msg-collapsible-wrap${collapsedMsgs.has(msg.id) ? ' ds-msg-collapsed' : ''}` },
                    ...
                    (() => {
                        ...
                        return (React.createElement("div", { className: "ds-bubble-toolbar" },
                            React.createElement("div", { className: "ds-bubble-toolbar-left" }, showPush && (React.createElement("button", { className: "ds-bubble-tool-btn", title: hasCode ? 'Push code to new cell' : 'Push response to markdown cell', onClick: () => {
                                    var _a, _b;
                            ...
                            React.createElement("div", { className: "ds-bubble-toolbar-right" },
                                ...
                                isLong && (React.createElement("button", { className: "ds-bubble-tool-btn", title: collapsedMsgs.has(msg.id) ? 'Expand' : 'Collapse', onClick: () => toggleCollapse(msg.id) },
