            ...
            React.createElement("div", { className: "ds-input-body" },
                ...
                React.createElement("textarea", { ref: textareaRef, className: "ds-assistant-input", value: input, style: { minHeight: MIN_INPUT_HEIGHT, maxHeight: inputHeight }, onChange: e => {
                        ...
                        if (atMatch) {
                            ...
                            const nbPath = (_c = (_b = notebookReader.getFullContext()) === null || _b === void 0 ? void 0 : _b.notebookPath) !== null && _c !== void 0 ? _c : '';
                            if (nbPath) {
                                apiClient.fetchSymbols(nbPath).then(syms => setAtSymbols(syms)).catch(() => { });
                            }
                        }
                            ...
                            setAtQuery('');
                            setAtFocusIdx(0);
                            const nbPath = (_e = (_d = notebookReader.getFullContext()) === null || _d === void 0 ? void 0 : _d.notebookPath) !== null && _e !== void 0 ? _e : '';
                            if (nbPath) {
                                apiClient.fetchSymbols(nbPath).then(syms => setAtSymbols(syms)).catch(() => { });
                            }
                        }
