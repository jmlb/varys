...
const ModelSwitcher = ({ provider, model, zoo, saving, onSelect }) => {
    ...
    return (React.createElement("div", { className: "ds-model-switcher", ref: wrapperRef },
        ...
        React.createElement("button", { className: `ds-model-switcher-btn${open ? ' ds-model-switcher-btn--open' : ''}${saving ? ' ds-model-switcher-btn--saving' : ''}${noProvider ? ' ds-model-switcher-btn--unconfigured' : ''}`, onClick: () => !saving && setOpen(o => !o), title: noProvider ? 'No provider configured — open Settings' : `${displayProvider} · ${model}\nClick to switch chat model`, disabled: saving },
        ...
        open && (React.createElement("div", { className: "ds-thread-popup" },
            ...
            threads.map(t => (React.createElement("div", { key: t.id, className: `ds-thread-item${t.id === currentId ? ' ds-thread-item-active' : ''}` },
                ...
                React.createElement("div", { className: "ds-thread-actions" },
                    ...
                    React.createElement("span", { className: "ds-thread-action-btn", onClick: e => { e.stopPropagation(); onDuplicate(t.id); }, title: "Duplicate thread" },
                        React.createElement("svg", { viewBox: "0 0 14 14", width: "11", height: "11", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    ...
                    threads.length > 1 && (React.createElement("span", { className: "ds-thread-action-btn ds-thread-action-delete", onClick: e => { e.stopPropagation(); onDelete(t.id); }, title: "Delete thread" },
                        React.createElement("svg", { viewBox: "0 0 14 14", width: "11", height: "11", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
const DSAssistantChat = ({ apiClient, notebookReader, cellEditor, notebookTracker }) => {
    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        React.createElement("div", { className: "ds-assistant-header" },
            ...
            React.createElement("button", { className: "ds-wiki-help-btn", onClick: () => window.open('https://github.com/jmlb/varys#readme', '_blank'), title: "Open documentation wiki" }, "?"),
            React.createElement("button", { className: "ds-settings-gear-btn", onClick: () => setShowSettings(true), title: "Settings" }, "\u2699")),
                ...
                React.createElement("div", { className: `ds-code-review-message ds-msg-collapsible-wrap${collapsedMsgs.has(msg.id) ? ' ds-msg-collapsed' : ''}` },
                    ...
                    msg.role === 'user' && msg.id !== editingMsgId && !isLoading && (React.createElement("div", { className: "ds-bubble-toolbar ds-bubble-toolbar-user" },
                        ...
                        React.createElement("div", { className: "ds-bubble-toolbar-right" },
                            React.createElement("button", { className: "ds-bubble-tool-btn", title: "Edit and resend", onClick: () => {
                                    var _a;
                    ...
                    (() => {
                        ...
                        if (msg.role === 'user' && msg.id === editingMsgId) {
                            return (React.createElement("div", { className: "ds-msg-edit-wrap" },
                                React.createElement("textarea", { className: "ds-msg-edit-textarea", value: editingText, autoFocus: true, onChange: e => setEditingText(e.target.value), onKeyDown: e => {
                                        if (e.key === 'Escape')
                    ...
                    (() => {
                        ...
                        return (React.createElement("div", { className: "ds-bubble-toolbar" },
                            React.createElement("div", { className: "ds-bubble-toolbar-left ds-bubble-toolbar-actions" },
                                showPush && (React.createElement("button", { className: "ds-bubble-tool-btn", title: hasCode ? 'Push code to new cell' : 'Push response to markdown cell', onClick: () => {
                                        var _a, _b;
                                ...
                                React.createElement("button", { className: "ds-bubble-tool-btn", title: "Copy response", onClick: () => {
                                        var _a, _b;
                            ...
                            React.createElement("div", { className: "ds-bubble-toolbar-right" }, isLong && (React.createElement("button", { className: "ds-bubble-tool-btn", title: collapsedMsgs.has(msg.id) ? 'Expand' : 'Collapse', onClick: () => toggleCollapse(msg.id) },
        ...
        React.createElement("div", { className: "ds-assistant-input-area" },
            ...
            React.createElement("div", { className: "ds-assistant-input-bottom" },
                ...
                React.createElement("div", { className: "ds-input-controls" },
                    React.createElement("button", { className: `ds-nb-aware-btn${notebookAware ? ' ds-nb-aware-on' : ' ds-nb-aware-off'}`, onClick: handleToggleNotebookAware, title: notebookAware
                            ? 'Notebook included — cell contents sent with every message. Click to exclude.'
                            : 'Notebook excluded — messages sent without cell contents. Click to include.', "aria-label": notebookAware ? 'Notebook included' : 'Notebook excluded' },
                        React.createElement("span", { className: "ds-nb-aware-check" }, notebookAware ? '☑' : '☐'),
                        React.createElement("span", { className: "ds-nb-aware-label" }, "ctx NB")),
                    React.createElement("span", { className: "ds-controls-sep" }, "|"),
                    React.createElement("label", { className: "ds-cell-mode-label", title: notebookAware ? CELL_MODE_TITLE[cellMode] : 'Insert to cell: No — notebook context is off' },
                        "ToCell:",
