...
const SettingsPanel = ({ apiClient, onClose, onSaved, notebookPath = '' }) => {
    ...
    return (React.createElement("div", { className: "ds-settings-outer" },
        ...
        topTab === 'models' ? (React.createElement(ModelsPanel, { apiClient: apiClient, onClose: onClose, onSaved: onSaved, notebookPath: notebookPath })) : (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: `ds-code-review-message ds-msg-collapsible-wrap${collapsedMsgs.has(msg.id) ? ' ds-msg-collapsed' : ''}` },
                    ...
                    (() => {
                        ...
                        return (React.createElement("div", { className: `ds-msg-collapsible-wrap${collapsed ? ' ds-msg-collapsed' : ''}` },
                            React.createElement("div", { className: "ds-assistant-message-content ds-markdown", dangerouslySetInnerHTML: { __html: renderMarkdown((_c = msg.displayContent) !== null && _c !== void 0 ? _c : msg.content) } }),
                    ...
                    !activeStreamId || msg.id !== activeStreamId ? (((_d = (_c = msg.content) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) >= COLLAPSE_THRESHOLD ? (React.createElement("button", { className: "ds-msg-toggle-btn", title: collapsedMsgs.has(msg.id) ? 'Expand' : 'Collapse', onClick: () => toggleCollapse(msg.id) }, collapsedMsgs.has(msg.id) ? '⌄' : '⌃')) : null) : null,
                    msg.role === 'assistant' && msg.id !== activeStreamId && !msg.hadCellOps && (() => {
                        const blocks = extractCodeBlocks(msg.content);
                        if (blocks.length === 0)
                            return null;
                        const allCode = blocks.join('\n\n');
                        return (React.createElement("button", { className: "ds-push-to-cell-btn", title: "Push to cell", onClick: () => {
                                var _a, _b;
