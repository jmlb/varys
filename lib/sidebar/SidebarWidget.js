        ...
        React.createElement("div", { className: "ds-assistant-input-area" },
            ...
            React.createElement("div", { className: "ds-assistant-input-bottom" },
                ...
                React.createElement("div", { className: "ds-input-controls" },
                    React.createElement("button", { className: `ds-nb-aware-btn${notebookAware ? ' ds-nb-aware-on' : ' ds-nb-aware-off'}`, onClick: handleToggleNotebookAware, "data-tip": notebookAware
                            ? 'Notebook included — click to exclude'
                            : 'Notebook excluded — click to include', "aria-label": notebookAware ? 'Notebook included' : 'Notebook excluded' },
