...
const ImageRecoveryPrompt = ({ onSelect }) => {
    ...
    return (React.createElement("div", { className: "ds-img-rec" },
        ...
        React.createElement("div", { className: "ds-img-rec-wrap", ref: dropRef },
            React.createElement("button", { className: `ds-img-rec-trigger${open ? ' ds-img-rec-trigger--open' : ''}`, onClick: () => { setOpen(o => !o); setShowCustom(false); } },
                "Choose action ",
                React.createElement("span", { className: "ds-img-rec-caret" }, open ? '▲' : '▼')),
            open && (React.createElement("div", { className: "ds-img-rec-menu" },
                [
                    ['/no_figures', 'Exclude all figures'],
                    ['/resize(7800)', 'Resize to 7800 px  (Anthropic)'],
                    ['/resize(6000)', 'Resize to 6000 px  (OpenAI)'],
                ].map(([cmd, desc]) => (React.createElement("button", { key: cmd, className: "ds-img-rec-item", onClick: () => pick(cmd) },
    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        ...
        React.createElement("div", { ref: messagesContainerRef, className: "ds-assistant-messages", onClick: (e) => {
            ...
            messages.map(msg => {
                ...
                React.createElement(ImageRecoveryPrompt, { onSelect: cmd => void handleSend(cmd) })) : msg.role === 'disambiguation' ? (
                /* ── Disambiguation card ───────────────────────────── */
