...
const TagsSettingsPanel = () => {
    ...
    const addCustomTag = () => {
        ...
        if (allBuiltInNames.includes(raw)) {
            setNameErr('This name is already a built-in tag.');
            return;
        }
    ...
    return (React.createElement("div", { className: "ds-tags-settings-panel" },
        ...
        React.createElement("div", { className: "ds-tags-settings-section" },
            ...
            customTags.map((tag, idx) => (React.createElement("div", { key: tag.name, className: "ds-tags-settings-row" },
                React.createElement("span", { className: "ds-tags-settings-pill", style: { '--pill-color': tagColorTs(tag.name) } }, tag.name),
            ...
            React.createElement("div", { className: "ds-tags-settings-new-form" },
                React.createElement("div", { className: "ds-tags-settings-new-row" },
                    React.createElement("input", { className: "ds-tags-settings-name-input", placeholder: "tag-name", value: newName, onChange: e => { setNewName(e.target.value); setNameErr(''); }, onKeyDown: e => { if (e.key === 'Enter')
                            addCustomTag(); } }),
                    React.createElement("input", { className: "ds-tags-settings-desc-input", placeholder: "Description (optional)", value: newDesc, onChange: e => setNewDesc(e.target.value), onKeyDown: e => { if (e.key === 'Enter')
                            addCustomTag(); } }),
                    React.createElement("button", { className: "ds-tags-settings-add-btn", onClick: addCustomTag, disabled: !newName.trim() }, "+ Add")),
        ...
        React.createElement("div", { className: "ds-tags-settings-section" },
            React.createElement("div", { className: "ds-tags-settings-section-header" },
                ...
                React.createElement("span", { className: "ds-tags-settings-section-count" }, allBuiltInNames.length)),
            BUILT_IN_TAG_DEFS.map(group => (React.createElement("div", { key: group.category, className: "ds-tags-settings-group" },
                ...
                group.tags.map(tag => (React.createElement("div", { key: tag.name, className: "ds-tags-settings-row ds-tags-settings-row--builtin" },
                    React.createElement("span", { className: "ds-tags-settings-pill", style: { '--pill-color': tagColorTs(tag.name) } }, tag.name),
...
const DSAssistantChat = ({ apiClient, notebookReader, cellEditor, notebookTracker }) => {
    ...
    priorMessages) => {
        ...
        try {
            ...
            let thoughtsAccum = '';
            const response = await apiClient.executeTaskStreaming(Object.assign(Object.assign({ message, notebookContext: context, chatHistory, variables: resolvedVariables }, (slashCommand ? { command: slashCommand } : {})), { cellMode: notebookAware ? cellMode : 'chat', thinkingEnabled: thinkingEnabledRef.current || undefined }), 
                ...
                React.createElement("div", { className: `ds-code-review-message ds-msg-collapsible-wrap${collapsedMsgs.has(msg.id) ? ' ds-msg-collapsed' : ''}` },
                    ...
                    (() => {
                        ...
                        return (React.createElement("div", { className: `ds-msg-collapsible-wrap${collapsed ? ' ds-msg-collapsed' : ''}` },
                            msg.role === 'assistant' && msg.thoughts && (React.createElement("div", { className: `ds-thinking-section${isStreaming ? ' ds-thinking-section--active' : ''}` },
                                React.createElement("button", { className: "ds-thinking-header", onClick: () => toggleThinkCollapsed(msg.id), title: thinkCollapsed.get(msg.id) ? 'Show reasoning' : 'Hide reasoning' },
                                    ...
                                    React.createElement("span", { className: "ds-thinking-chevron" }, thinkCollapsed.get(msg.id) ? '▸' : '▾')),
                                !thinkCollapsed.get(msg.id) && (React.createElement("div", { className: "ds-thinking-body", ref: el => {
                                        if (el)
            ...
            React.createElement("div", { className: "ds-input-body" },
                React.createElement("div", { className: "ds-nb-ctx-row" },
                    ...
                    React.createElement("button", { className: `ds-nb-ctx-chip${notebookAware ? ' ds-nb-ctx-chip--on' : ' ds-nb-ctx-chip--off'}`, onClick: handleToggleNotebookAware, "data-tip": notebookAware
                        ...
                        "notebook"),
                    React.createElement("button", { className: `ds-thinking-chip${thinkingEnabled ? ' ds-thinking-chip--on' : ' ds-thinking-chip--off'}`, onClick: () => {
                            const next = !thinkingEnabled;
                            setThinkingEnabled(next);
                            try {
                                localStorage.setItem('ds-varys-thinking', String(next));
                            }
                            catch ( /* ignore */_a) { /* ignore */ }
                        }, "data-tip": thinkingEnabled
                            ? 'Sequential reasoning ON — click to disable.'
                            : 'Sequential reasoning OFF — click to enable.', "aria-label": thinkingEnabled ? 'Sequential reasoning enabled' : 'Sequential reasoning disabled' },
                        "\uD83E\uDDE0 Reasoning: ",
