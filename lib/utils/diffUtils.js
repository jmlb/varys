...
export function getDiffStats(lines) {
 ...
 */
export function splitIntoHunks(lines, contextLines = 2) {
    const hunks = [];
    let hunkId = 0;
    let i = 0;
 ...
 */
export function reconstructFromHunks(lines, hunks, decisions) {
    var _a;
 ...
 */
export function collapseContext(lines, contextLines = 3) {
    if (lines.length === 0)
        return lines;
    // Mark lines to keep
