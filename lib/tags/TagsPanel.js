        ...
        React.createElement("div", { className: "ds-tp-create-section" },
            ...
            React.createElement("div", { className: "ds-tp-create-body" },
                ...
                React.createElement("div", { className: "ds-tp-create-preview" },
                    ...
                    React.createElement("pre", { className: "ds-tp-preview-json" }, previewJson)))),
        React.createElement("div", { className: "ds-tp-body" },
            ...
            React.createElement("div", { className: "ds-tp-details" }, selectedTag ? (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "ds-tp-details-json" },
                    React.createElement("pre", { className: "ds-tp-details-json-pre" }, JSON.stringify({ value: selectedTag, topic: selTopic, description: selDesc, color: selColor }, null, 2))),
                ...
                isCustom && (React.createElement("button", { className: "ds-tp-details-del-btn", onClick: () => deleteCustomTag(selectedTag) }, "\uD83D\uDDD1 Delete")))) : (React.createElement("p", { className: "ds-tp-details-hint" }, "\u2190 Select a tag"))))));
};
